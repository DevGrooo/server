...
class TradingOrderFeeBuy extends Model
{
     ...
     * @var string
     */
    protected $table = 'trading_order_fee_buy';
     ...
     * @var array
     */
    protected $fillable = ['fund_company_id', 'fund_certificate_id', 'fund_product_id', 'investor_id', 'start_at', 'end_at', 'min_amount', 'fee_amount', 'fee_percent', 'status', 'requested_at', 'rejected_at', 'accepted_at', 'locked_at', 'created_by', 'updated_by', 'requested_by', 'rejected_by', 'accepted_by', 'locked_by'];
    ...
    /**
     * Get the fund_company record associated with the trading_order_fee_buy.
     */
    ...
    /**
     * Get the fund_certificates record associated with the trading_order_fee_buy.
     */
    ...
    /**
     * Get the fund_products record associated with the trading_order_fee_buy.
     */
    ...
    /**
     * Get the investors record associated with the trading_order_fee_buy.
     */
    ...
    public static function setFee($model, &$fee, &$fee_send, &$fee_receive) {
        $fee = 0;
        $fee_send = 0;
        $fee_receive = 0;
    }
    ...
    public static function getListStatus() {
        return array(
            TradingOrderFeeBuy::STATUS_NEW => trans('status.trading_order_fee_buy.active'),
            TradingOrderFeeBuy::STATUS_LOCK => trans('status.trading_order_fee_buy.lock'),
        );
    }
}
